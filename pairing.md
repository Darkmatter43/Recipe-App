...
## Intro
GitHub allows for amazing collaboration to happen! For tonight’s homework, you will be asked to complete the task in groups of 2. For this morning exercise, you will work together to setup and help collaboration this evening go smoothly.
## Deliverables
### Coder's Choice HW
...
## Tasks
### The Owner's tasks
- go to your own GitHub profile page and choose `Create New`
...
### The Collaborator's tasks
- Go to a location in your terminal that is OUTSIDE of the class repo in preparation for cloning the owner's repo
    _NOTE_: you do not need to make a subfolder. Cloning will make your repo folder at the level where you're at
...
### All Member's Tasks Part 1 (Everyone should do these steps!)
...
- Write a very basic `server.js`
  - Your server should be able to `res.send('Hello World')` to a `/` route at `localhost:3000`
    - *DO NOT* try to add more modules, create more routes etc. in an effort to 'get ahead' on the hw right now - the lab for now is for helping make sure everyone can collaborate on git/github, if you finish setting up early then you can start on the homework - but get set up first! New group work always starts a little slow. Be patient and make sure you get things right and squash the little bugs before they become big headaches!
  - `git add`
  - `git commit`
...
## Workflow
- Try to abide by the below workflow. You will likely make mistakes and that's ok - figure out how to move forward rather than to start over or do really hard to understand git commands we haven't covered. Keep practicing to get the work flow right!
...
## Resources
- [Class Wiki](https://git.generalassemb.ly/Software-Engineering-Immersive-Remote/SEIR-Moss/wiki/Git-Cheatsheet)
- [Happy Fun Ball](/unit_3/w07d05/morning_exercise)
